...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BetCoin: 0.35 days
static const int64 nTargetSpacing = 120; // BetCoin: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 130000000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085386442;

        if (fTestNet)
        {
            block.nTime    = 130000000;
